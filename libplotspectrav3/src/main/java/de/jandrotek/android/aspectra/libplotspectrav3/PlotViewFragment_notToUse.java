 ...
 * {@link PlotViewFragment_notToUse.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PlotViewFragment_notToUse#newInstance} factory method to
    ...
    implements         View.OnCreateContextMenuListener
{
     ...
     */
        public static PlotViewFragment_notToUse newInstance(int param1, ArrayList<String> items) {
    ...
    public PlotViewFragment_notToUse() {
